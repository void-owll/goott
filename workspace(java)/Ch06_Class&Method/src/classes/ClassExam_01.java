...
public class ClassExam_01 {
	 ...
	 * 알아서 해당 자료형의 default(기본) 값을 설정을 해 줌.
	 */
	int num;			// 멤버변수 - 전역변수 ==> 글자 색이 다르다.
	...
	public static void main(String[] args) {
		...
		// 형식)
		//		클래스이름 참조변수(=클래스별칭);
		//ClassExam_01 exam;		// exam => 참조변수(클래스 별칭)
		
		// 2단계 : 클래스를 메모리(heap memory)에 생성.
		// 형식)
		//		참조변수 = new 클래스이름(); 		// 클래스이름은 정확하지 않고, 생성자임.
		//exam = new ClassExam_01();
		
		// 1단계 + 2단계 : 클래스 선언 및 클래스 메모리 생성.
		ClassExam_01 exam = new ClassExam_01();		// 참조변수에는 생성된 Class의 Heap메모리의 시작주소가 들어있다.
